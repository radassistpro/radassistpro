...
export default function BookCallPage() {
  return (
    <>
      ...
      <section className="relative min-h-[50vh] overflow-hidden bg-navy-950 pt-32 pb-16 grain lg:pt-40 lg:pb-20">
        ...
        <div className="container-wide relative px-5 lg:px-8">
          <FadeIn>
            ...
            <p className="mt-5 max-w-xl text-lg text-white/70">
              A 15-minute call with our U.S. team to review your volumes,
              modalities, and coverage gaps. We follow up with a scoped plan
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
            <FadeIn>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-section text-2xl text-navy-950">
                    What we&apos;ll cover
                  </h2>
                ...
                <div className="rounded-2xl border border-border bg-surface p-6">
                  ...
                  <ul className="mt-5 space-y-4">
                    <li className="flex items-center gap-3 text-sm text-navy-800">
                      ...
                      <a href={`tel:${siteConfig.phone.replace(/\D/g, "")}`} className="hover:text-accent cursor-pointer">
                        {siteConfig.phone}
                      </a>
                    </li>
                    <li className="flex items-center gap-3 text-sm text-navy-800">
                      <Mail className="h-4 w-4 text-accent" />
                      <a href={`mailto:${siteConfig.email}`} className="hover:text-accent cursor-pointer">
                        {siteConfig.email}
                      </a>
                    </li>
